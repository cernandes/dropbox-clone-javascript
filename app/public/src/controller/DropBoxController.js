class DropBoxController {
    ...
    firebaseConection() {
        var firebaseConfig = {
            apiKey: "AIzaSyBUnA7lDlzAbNqtw1qCNY4GkW6vVmLK2z4",
            authDomain: "dropbox-clone-cca30.firebaseapp.com",
            databaseURL: "https://dropbox-clone-cca30.firebaseio.com",
            projectId: "dropbox-clone-cca30",
            storageBucket: "dropbox-clone-cca30.appspot.com",
            messagingSenderId: "641546576449",
        ...
        return new Promise((resolve, reject) => {
            ...
            folderRef.on('value', snapshot => {
                ...
                if (snapshot.exists()) {
                    ...
                    this.getFirebaseRef('Arquivos').child(key).remove();
    ...
    //remover arquivos do firabase storage
    removeFile(ref, name) {
    ...
    //eventos de ação nas pastas e arquivos
    initEvents() {
        ...
        this.btnRename.addEventListener('click', e => {
            ...
            let rename = prompt('Renomear o arquivo', file.name);
    ...
    //referencia do caminho firebase
    getFirebaseRef(path) {
    ...
    //eventos de click e duplo click nos arquivos
    initEventsLi(li) {
